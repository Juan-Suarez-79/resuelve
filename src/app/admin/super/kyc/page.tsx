    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <h1 className="text-3xl font-bold text-white mb-1">Verificaciones KYC</h1>
                ...
                <div className="relative w-full md:w-64">
                    ...
                    <input
                        ...
                        className="w-full bg-gray-950 border border-gray-800 text-white pl-10 pr-4 py-2 rounded-xl focus:border-brand-red outline-none transition-all placeholder:text-gray-600"
                    />
                </div>
            </div>
